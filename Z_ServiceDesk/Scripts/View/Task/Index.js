...
function GetSupplierCategoryLists() {
    $.ajax({
        type: "Get",
        async: false,
        url: apiurl + 'api/Task/GetSupplierCategoryLists',
...
function GetSupplierStatusLists() {
    $.ajax({
        type: "Get",
        async: false,
        url: apiurl + 'api/Task/GetSupplierStatusLists',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
function GetSupplierLocationLists() {
    $.ajax({
        type: "Get",
        async: false,
        url: apiurl + 'api/Task/GetVendorCityList',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
function GetSupplierDetails() {
    ...
    $.ajax({
        type: "Post",
        contentType: "application/json; charset=utf-8",
        url: apiurl + 'api/Task/GetSupplierDetailsFilter',
        dataType: "json",
        data: josnstr,
        success: function (data) {
            //alert(data.status);
...
function UpdateSupplierStatus(supplier_id) {
    ...
    $.ajax({
        ...
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        url: apiurl + 'api/Task/UpdateSupplierStatus',
        success: function (data) {
            if (data.status_id != 0) {
...
function DeleteSupplier(supplier_id) {
    ...
    $.ajax({
        type: "Post",
        contentType: "application/json; charset=utf-8",
        url: apiurl + 'api/Task/DeleteSupplierByID',
        data: josnstr,
        dataType: "json",
        success: function (data) {
            if (data.status_id == "1") {
