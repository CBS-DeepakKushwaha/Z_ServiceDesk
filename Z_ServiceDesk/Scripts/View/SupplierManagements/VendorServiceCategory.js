...
function InsSupplierCategory() {
    ...
    $.ajax({
        ...
        url: apiurl + 'api/Supplier/InsVendorServiceCategory',
...
function GetVendorServiceCategoryLists() {
    $.ajax({
        type: "Get",
        contentType: "application/json; charset=utf-8",
        url: apiurl + 'api/Supplier/GetVendorServiceCategoryLists',
        dataType: "json",
        success: function (data) {
            //alert(data.status);
            var table;
            ...
            $("#tblSupplierCategory").DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'service_cat_id_pk',
                        sWidth: '2px',
                        sClass: "view",
                        bSortable: false,
                        render: function (service_cat_id_pk) {
                            return '<input id="check" class="cb-element checkbox" name="' + service_cat_id_pk + '" type="checkbox">';  // <button class="btn btn-xs btn-success grid-buttons btnedit" name="' + catogory_id_pk + '" style="margin-right:5px;"><i class="fa fa-edit icon-ser"></i></button>
                        }
                    },
                    { data: 'service_cat_id_pk' },
                    { data: 'category_name' },
                    {
                        data: 'service_cat_id_pk', sWidth: '200px', render: function (service_cat_id_pk, type, row) {
                            return '<i class="fa fa-edit editview" onclick="OpenEdit(' + service_cat_id_pk + ')" data-toggle="tooltip" title="" style="color:#35adaf !important; font-size:17px" data-original-title="Normal priority"></i><a class="btnDelete" href="#" onclick="ConfirmDelete(' + service_cat_id_pk + ')"> <i class="fa fa-trash" data-toggle="tooltip" title="" style="font-size:17px;color:#f64e60 !important" data-original-title="Normal priority"></i> &nbsp; </a>';
...
function DeleteSupplierCategoryByID(sup_category_id) {
    ...
    $.ajax({
        type: "Post",
        contentType: "application/json; charset=utf-8",
        url: apiurl + 'api/Masters/DeleteVendorServiceCategoryByID',
        data: josnstr,
        dataType: "json",
        success: function (data) {
            if (data.status_id == "1") {
...
function OpenEdit(id) {
    ...
    $.ajax({
        type: "Post",
        contentType: "application/json; charset=utf-8",
        url: apiurl + 'api/Masters/GetVendorServiceCategoryById',
        data: josnstr,
        dataType: "json",
        success: function (data) {
            $("#txtEditVendorCtaegory").val(data.category_name);
            $("#txtEditVendorCtaegory").attr('name', data.service_cat_id_pk);
        },
        error: function (result) {
            alert("Error Occured");
        }
...
function updatename() {
    ...
    $.ajax({
        type: "Post",
        contentType: "application/json; charset=utf-8",
        url: apiurl + 'api/Masters/UpdateVendorServiceById',
        data: josnstr,
        dataType: "json",
        success: function (data) {
            if (data.status_id == 1) {
