...
namespace Api_ZserviceDesk.Controllers
{
    ...
    public class ProjectController : ApiController
    {
        ...
        //[HttpGet]
        //public IEnumerable<zdesk_m_project_manag_status_master_tbl> GetProjectStatusList()
        //{
        //    var db = new Database("Constr");
        //    db.EnableAutoSelect = false;
        //    return db.Query<zdesk_m_project_manag_status_master_tbl>("  exec zdesk_get_project_status_list_sp");
        //}
        [HttpGet]
        ...
        [HttpPost]
        public IEnumerable<zdesk_m_project_manag_status_master_tbl> GetProjectDetails()
        {
            var db = new Database("Constr");
            db.EnableAutoSelect = false;
            return db.Query<zdesk_m_project_manag_status_master_tbl>("exec zdesk_m_project_manag_status_master_sp");
        }
    }
}
